<template>
    <div>
        ...
        <el-card class="box-card">
            ...
            <el-row :gutter="30">
                <el-col :span="8">
                    <el-input placeholder="请输入内容" v-model="queryInfo.query" @keyup.enter.native="getTeacherList">
        ...
        <el-dialog title="添加教师" :visible.sync="addDialogVisible" width="25%" @close="addDialogClose">
          ...
          <el-form :model="addForm" :rules="addFormRules" ref="addFormRef" label-width="70px">
            ...
            <el-form-item label="权限" prop="TeaRid">
              <el-input v-model="addForm.TeaRid"></el-input>
            </el-form-item>
        ...
        <!-- 修改教师信息模态框 -->
        <el-dialog title="修改教师信息" :visible.sync="editDialogVisible" width="20%">
...
export default {
  ...
  methods: {
    async getTeacherList () {
      const { data: res } = await this.$http.get('/dark/admin/teachers', {
    ...
    addTeacher () {
      ...
      this.$refs.addFormRef.validate(async valid => {
        ...
        const { data: res } = await this.$http.post('/dark/admin/teachers/add', this.qs.stringify(this.addForm))
    ...
    editTeacher () {
      this.$refs.editFormRef.validate(async valid => {
        ...
        const { data: res } = await this.$http.put('/dark/admin/teachers/update', this.qs.stringify(this.editForm))
        if (res.meta.status !== 200) {
